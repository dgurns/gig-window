...
export class addAwsMediaLiveChannelEnteredRunningStateTimestamp1597610562680 implements MigrationInterface {
    name = 'addAwsMediaLiveChannelEnteredRunningStateTimestamp1597610562680'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" ADD "awsMediaLiveChannelEnteredRunningStateTimestamp" TIMESTAMP WITH TIME ZONE DEFAULT null`, undefined);
